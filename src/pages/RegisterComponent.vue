        ...
        <q-card class="register-form">
          <q-card-section>
            <div class="form-container">
              ...
              <input v-model="id_num" type="text" id="id_num" class="id" name="id_num" placeholder="ID Number" required><br><br>

              <input v-model="fname" type="text" id="fname" class="fname" name="fname" placeholder="First Name" required><br><br>

              <input v-model="mname" type="text" id="mname" class="mname" name="mname" placeholder="Middle Name" required><br><br>

              <input v-model="lname" type="text" id="lname" class="lname" name="lname" placeholder="Last Name" required><br><br>

              <input v-model="address" type="text" id="address" class="address" name="address"
                placeholder="Address" required><br><br>

              <input v-model="age" type="text" id="age" class="age" name="age" placeholder="Age" required><br><br>
              ...
              <input v-model="gname" type="text" id="gname" class="gname" name="gname"
                placeholder="Guardian/Parent Name" required><br><br>
