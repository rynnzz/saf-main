<template>
  <div>
    <header>
      ...
      <h2 style="color: #ea4335;">CORDOVA</h2>
      <h2 style="color: #4285f4;">PUBLIC COLLEGE</h2>
    </header>
      ...
      <div align="right" style="margin-right: 150px;">
        <form @submit.prevent="login">
          ...
          <div class="login-button">
            <q-btn type="submit" color="blue" icon="eco" style="width: 150px; height: 40px; border-radius: 10px;" label="Login" />
          </div>
          <div class="register-button">
            <router-link to="/RegisterComponent">
              <q-btn type="button" color="green" style="width: 190px; height: 40px; border-radius: 10px;"><i class="mx-2"><svg
      ...
      try {
        ...
        if (responseData && responseData.success) {
          ...
          if (responseData.userType === 'admin') {
            ...
            // Redirect to the appropriate page for teachers
            this.$router.push({ name: 'HomeComponent' });
          } else {
            this.$router.push({ name: 'HomeComponent' });
          }
